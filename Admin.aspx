			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<div class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
                                    <asp:TextBox ID="txtpassword" runat="server" class="input100" TextMode="Password" placeholder="Password"></asp:TextBox>
                    ...
                    <a class="txt1 bo1 hov1" href="Appointment.aspx">
							Back to Home					
						</a>
                    <br />
					
                    <a class="txt1 bo1 hov1" href="Forgot.aspx">
							Forgot Password?					
						</a>
