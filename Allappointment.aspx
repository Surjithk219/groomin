<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Allappointment.aspx.cs" Inherits="Allappointment" %>
...
<a href="#serSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Services</a>
	...
	<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataKeyNames="apt_id" DataSourceID="SqlDataSource1" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                            <Columns>
                                <asp:BoundField DataField="apt_id" HeaderText="ID" InsertVisible="False" ReadOnly="True" SortExpression="apt_id" />
                                <asp:BoundField DataField="name" HeaderText="NAME" SortExpression="name" />
                                <asp:BoundField DataField="aptnumber" HeaderText="APPOINTMENT NUMBER" SortExpression="aptnumber" />
                               ...
                               <asp:BoundField DataField="aptdate" HeaderText="APPOINTMENT DATE" SortExpression="aptdate" />
                                ...
                                <asp:BoundField DataField="tym" HeaderText="TIME" SortExpression="tym" />
                                          <asp:HyperLinkField Text="VIEW" DataNavigateUrlFields="aptnumber" DataNavigateUrlFormatString="Viewappoinment.aspx?aptnumber={0}"/>
                            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyConnections %>" SelectCommand="SELECT [apt_id], [name], [aptnumber], [email], [phone], [aptdate], [service], [tym] FROM [Appointment]"></asp:SqlDataSource>
