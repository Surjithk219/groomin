			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        <asp:TextBox ID="txtabout" runat="server" placeholder="Page Title" class="form-control">
</asp:TextBox>
<asp:TextBox ID="txtdescription" runat="server" placeholder="Page Description" class="form-control"></asp:TextBox>

                        <asp:Button ID="Button2" runat="server" Text="ADD" class="btn btn-primary pull-right" OnClick="Button2_Click" />
