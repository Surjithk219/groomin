<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bwdates.aspx.cs" Inherits="bwdates" %>
...
<a href="#serSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Services</a>
    ...
    <asp:TextBox ID="TextBox2" runat="server"  Class="form-control "  TextMode="Date"></asp:TextBox>     
			       ...
			       <asp:Button ID="Button2" class="btn btn-primary pull-right" runat="server" Text="SUBMIT" OnClick="Button2_Click" />   	
