<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Searchinvoice.aspx.cs" Inherits="Searchinvoice" %>
...
<a href="#serSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Services</a>
				...
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        <div class="container-fluid">
                           <h2>Search Invoice Details  </h2>
                            <asp:Label ID="Label1" runat="server" Text="Search by Invoice Number or Billing Number"></asp:Label>
                            <asp:TextBox ID="txtseARCH" runat="server" class="form-control"></asp:TextBox>
                              <asp:Button ID="Button1" runat="server" class="btn btn-primary pull-right" OnClick="Button1_Click" Text="SEARCH" />
	...
	<h4 ><asp:Label ID="Label3" runat="server" Visible="false" Text="Search Against Keyword" ></asp:Label>  <asp:Label ID="Label2" runat="server" Visible="false" Text="Label"></asp:Label></h4>
                ...
                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound">
                    ...
                    <Columns>
                        <asp:TemplateField>
                          ...
                          <asp:HyperLinkField Text="view"  DataNavigateUrlFields="billingid" DataNavigateUrlFormatString="Viewinvoice.aspx?billingid={0}" HeaderText="ACTION" />
