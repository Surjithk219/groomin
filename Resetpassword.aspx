		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<div class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Passord is required: ex@abc.xyz">
						
                        <asp:TextBox ID="txtnew" runat="server" class="input100" placeholder="New Password"></asp:TextBox>
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Password is required">
                                    <asp:TextBox ID="txtcon" runat="server" class="input100"  placeholder="Confirm Password"></asp:TextBox>
