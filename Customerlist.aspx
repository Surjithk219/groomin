			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                      ...
                      <asp:GridView ID="GridView1" runat="server"  AutoGenerateColumns="False" AllowSorting="True" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" DataSourceID="SqlDataSource1" ForeColor="Black" DataKeyNames="customer_id">
                            <Columns>
                                <asp:BoundField DataField="customer_id" HeaderText="ID" SortExpression="customer_id" InsertVisible="False" ReadOnly="True" />
                                ...
                                <asp:BoundField DataField="creationdate" HeaderText="CREATION DATE" SortExpression="creationdate" />
                                 ...
                                 <asp:TemplateField>
                                     <ItemTemplate>
                                         <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# Eval("customer_id", "Editcustomer.aspx?customer_id={0}") %>' Text="Edit"></asp:HyperLink>
                                             || <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# Eval("customer_id", "Assignservice.aspx?customer_id={0}") %>' Text="Assign Service"></asp:HyperLink>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyConnections %>" SelectCommand="SELECT [customer_id], [name], [email], [creationdate] FROM [Customer]"></asp:SqlDataSource>
                       </div>  
                    </div>
                </div>
        </div>
