<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Editservice.aspx.cs" Inherits="Editservice" %>
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        Service<asp:TextBox ID="txtservice" runat="server"  placeholder="Service"></asp:TextBox>
                        Cost<asp:TextBox ID="txtcost" runat="server" placeholder="Cost"></asp:TextBox>
