<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Viewappoinment.aspx.cs" Inherits="Viewappoinment" %>
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
                        ...
                        APPOINTMENT NUMBER<asp:TextBox ID="txtaptno" runat="server" class="form-control"> </asp:TextBox>
